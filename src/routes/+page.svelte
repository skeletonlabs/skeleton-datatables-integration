<div class="space-y-10">
	...
	<p class="text-2xl text-center text-balance">
		...
		integrated with <a class="anchor" href="https://www.skeleton.dev/" target="_blank">Skeleton</a>.
	</p>
	<!-- CTA -->
	<div class="text-center">
		<a class="btn variant-filled" href="https://www.skeleton.dev/docs/ssd" target="_blank">
			View the Guide &rarr;
		</a>
	</div>
	<!-- Links -->
	<div class="max-w-[600px] mx-auto grid grid-cols-1 gap-4">
		...
		<a class="card card-hover overflow-hidden" href="/client">
			<header class="flex justify-between items-center p-4">
				<h3 class="h3">Client Example</h3>
				<h3 class="h3">&rarr;</h3>
			</header>
			<hr class="hr" />
			<div class="p-4 space-y-4">
				<article>
					<p>A simple example using local data available in your page.</p>
				</article>
			</div>
		</a>
		<!-- Server -->
		<a class="card card-hover overflow-hidden" href="/server">
			...
			<div class="p-4 space-y-4">
				<article>
					<p>
						An advanced example using remote data from <a
	...
	<footer class="text-center">
		<small>
			<span class="opacity-60">This guide was provided by Skeleton contributor </span>
			<a class="anchor" href="https://github.com/kmalloy24" target="_blank">Kyle Malloy</a>
		</small>
	</footer>
</div>
